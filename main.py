...
# CORRECCIÓN: Importamos load_scores y save_scores directamente desde utils.score
from utils.score import load_scores, save_scores 
import os # Asegurarse de importar os por si se necesita para rutas en el futuro
...
# pygame.time.wait(100) # Opcional: Pequeña pausa para permitir que la ventana se establezca
...
print("main.py: Fuentes cargadas (predeterminadas de Pygame).") # DEBUG
...
def main():
    ...
    while True:
        ...
        # Asegúrate de que estos argumentos coincidan con la definición de main_menu en menu.py
